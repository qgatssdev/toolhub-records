      ...
      <div className="footer">
        ...
        <div className="footer-content">
          ...
          <div className="footer-social-links">
            ...
            <p className="footer-social-link linkedin">
            ...
            <p className="footer-social-link twitter">
            ...
            <p className="footer-social-link youtube">
            ...
            <p className="footer-social-link github">
